...
from EventManagementSystem.views import slkf, province, district, association, genericUser
...
urlpatterns = [
    ...
    re_path(r'^accounts/signup/association$', association.AssociationSignUpView.as_view(), None, 'association_signup'),
    ...
    # TODO: Resolve this. Need to show message instead of page
    ...
    re_path(r'^user-profile/change-password$', auth_views.PasswordChangeView.as_view(), None,
            'reset-password'),
    ...
    # Delete objects
    re_path(r'^slkf-portal/display-associations/remove/(?P<pk>\d+)/$', slkf.delete_user,
            name='delete-association'),
    re_path(r'^slkf-portal/display-district-users/remove/(?P<pk>\d+)/$', slkf.delete_user,
            name='delete-district'),
    re_path(r'^slkf-portal/display-province-users/remove/(?P<pk>\d+)/$', slkf.delete_user,
            name='delete-province'),
    re_path(r'^slkf-portal/display-slkf-users/remove/(?P<pk>\d+)/$', slkf.delete_user,
            name='delete-slkf'),
    re_path(r'^slkf-portal/display-all-events/remove/(?P<pk>\d+)/$', slkf.delete_event,
            name='delete-event'),

    re_path(r'^association-portal/view-players/remove/(?P<pk>\d+)/$', association.delete_player,
            name='delete-player'),
    re_path(r'^association-portal/view-coaches/remove/(?P<pk>[\w\-]+)/$', association.delete_coach,
            name='delete-coach'),
